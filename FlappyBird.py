...
IMAGE_CANO = pygame.transform.scale2x(pygame.image.load(os.path.join('img','pipe.png')))
IMAGE_CHAO = pygame.transform.scale2x(pygame.image.load(os.path.join('img','base.png')))
...
class Cano:
    ...
    def definir_altura(self):
        ...
        self.pos_base = self.altura - self.CANO_TOPO.get.height()
